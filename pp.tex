...
Pour l'image d'un CSP $(C,\mathscr{C})$, on peut lui associer le couple
$(\Sigma, YX)$ où $\Sigma$ est l'aphabet sur lequel est définit $\mathscr{C}$
et $X : \Sigma^\op\rightarrow\fset$ le foncteur qui à $\star$ associe $C$, à
une relation associe sa définition dans $\mathscr{C}$ et à une flèche $f_j$
