...
% \usepackage[top=cm, bottom=2cm, left=2cm, right=2cm]{geometry}
\usepackage{amsmath}
\usepackage{amssymb}
...
\newtheorem*{definth}{Définition}
\theoremstyle{theostyle}
\newtheorem*{propnth}{Propriété}
\newtheorem*{propsnth}{Propriétés}
\newtheorem*{proponth}{Proposition}
\newtheorem*{theonth}{Th\'eor\`eme}
\newtheorem*{cornth}{Corollaire}
\newtheorem*{lemnth}{Lemme}
...
\newenvironment{prop}[1][]
  {\begin{leftbarviolet}\begin{propnth} \textbf{#1}\ \\}
  {\end{propnth}\end{leftbarviolet}}
